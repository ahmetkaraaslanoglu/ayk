        ...
        <div class="relative pt-6  pb-16 sm:pb-24 bg-gray-900 h-screen">
            ...
            <div class="relative">
                <div class="max-w-7xl mx-auto px-4 sm:px-6">
                    <div class="flex justify-between items-center border-b-2 border-gray-900 py-6 md:justify-start md:space-x-10">

                        <div class="flex justify-start lg:w-0 lg:flex-1">
                            <a href="#">
                                <span class="sr-only">AYK Education</span>
                                <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=white" alt="">
                            </a>
                        </div>

                        <div class="-mr-2 -my-2 md:hidden">
                            <button type="button" class="rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
                        ...
                        <nav class="hidden md:flex space-x-10">
                            <div class="relative">
                                <!-- Item active: "text-gray-900", Item inactive: "text-gray-500"  seçilince white olsun direkt-->
                                <button type="button" class="text-gray-500 group  rounded-md inline-flex items-center text-base font-medium hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" aria-expanded="false">
                                    <span>Ayk Education</span>
                                    <!--
                                ...
                                -->
                                <div class="opacity-0 translate-y-1 absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                            ...
                            <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-300"> Referanslar </a>
                            <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-300"> İletişim </a>
                            ...
                            <div class="relative">
                                ...
                                <!--
                                  ...
                                  Leaving: "transition ease-in duration-150"
                                    ...
                                    To: "opacity-0 translate-y-1"
                                -->
                                <div class="opacity-0 translate-y-1 absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                        <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                            <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                        ...
                        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                            <a href="/login/teacher" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-300"> Öğretmen Girişi Yap </a>
                        </div>

                        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                            <a href="/login/student" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-300"> Giriş Yap </a>
            ...
            <div class="mt-16 sm:mt-24">
                <div class="mx-auto max-w-7xl">
                    <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                        <div class="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                            <div>
                                <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                                    <span class="md:block">AYK Education,</span>
                                    <span class="text-indigo-400 md:block">Eğitimin dijital hali</span>
                                </h1>
                        ...
                        <div class="mt-16 sm:mt-24 lg:mt-10 lg:col-span-6 ">
                            <div class="sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
                                <img
                                    src="https://i.hizliresim.com/sx0gm8l.png"
                                />
                            </div>
                        </div>
                    </div>
